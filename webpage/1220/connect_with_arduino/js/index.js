                            ...
                            if((i>3&&i<10) || (i>17&&i<24) || (i>31&&i<41) || (i>52&&i<60)){
                                ...
                                if(scale_x > 0 && scale_y>0 && scale_z >0){
                                    if(i==5 || i==8 || i==19 || i==22 || i==33 || i==36 || i==39){
                                        if(sum_values[0]>0){
                                            scale_x = scale_y = scale_z = (200 - sum_values[0]/10) * 0.6;
                                        }
                                    }else if(i>52&&i<60){
                                        if(sum_values[1]!=0){
                                            scale_y = (200 - (4092 - sum_values[1])/18) * 0.6;
                                        }
                                    }else if(i==4 || i==7 || i==18 || i==21 || i==32 || i==35 || i==38){
                                        if(sum_values[2]<=120 && sum_values[2]!=0){
                                            scale_x = scale_y = scale_z = (200 - (sum_values[2]-60)*5) * 0.6;
                                        }
                                    }else if(i==6 || i==9 || i==20 || i==23 || i==34 || i==37 || i==40){
                                        if(sum_values[3]!=0){
                                            scale_x = scale_y = scale_z = (200 - sum_values[3]*3 -108) * 0.6;
                                        }
                                    }
                                    if(scale_y>0){
